...
use Vaniusa\BlogBundle\Entity\Category;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('VaniusaBlogBundle:Category')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Vaniusa\BlogBundle\Form\CategoryType', $category);
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('Vaniusa\BlogBundle\Form\CategoryType', $category);
