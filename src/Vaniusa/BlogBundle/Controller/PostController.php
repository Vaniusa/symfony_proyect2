...
use Vaniusa\BlogBundle\Entity\Post;
...
class PostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $posts = $em->getRepository('VaniusaBlogBundle:Post')->findAll();
    ...
    {
        $post = new Post();
        $form = $this->createForm('Vaniusa\BlogBundle\Form\PostType', $post);
    ...
    {
        $deleteForm = $this->createDeleteForm($post);
        $editForm = $this->createForm('Vaniusa\BlogBundle\Form\PostType', $post);
